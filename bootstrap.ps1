...
Import-Module -Name CITools -RequiredVersion (Install-PSModuleWithSpec -Name CITools -Major 2)
Import-Module -Name GitHubApiTools -RequiredVersion (Install-PSModuleWithSpec -Name GitHubApiTools -Major 1)
